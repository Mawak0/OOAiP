...
namespace SpaceBattle.Lib.Tests
{
    public class CollisionCommandTests
    {
        ...
        public void Execute_CollisionDetected_CommandExecuted()
        {
            ...
            var pos1 = new Vector(new int[] { 10, 20 });
            var pos2 = new Vector(new int[] { 12, 18 });
            var vel1 = new Vector(new int[] { 1, -1 });
            var vel2 = new Vector(new int[] { -1, 1 });
        ...
        public void Execute_NoCollisionDetected_CommandNotExecuted()
        {
            ...
            var pos1 = new Vector(new int[] { 10, 20 });
            var pos2 = new Vector(new int[] { 100, 200 });
            var vel1 = new Vector(new int[] { 1, -1 });
            var vel2 = new Vector(new int[] { -1, 1 });
